...
5. `docs/01_PRD.md`
6. `docs/02_BUSINESS_UX_FLOW.md`
7. `docs/03_ARCHITECTURE.md`
8. `docs/04_FRONTEND_UI_SYSTEM.md`
9. `docs/05_DATABASE.md`
10. `docs/06_API_CONTRACTS.md`
11. `docs/07_AI_FEATURE.md`
12. `docs/08_I18N.md`
13. `docs/09_DEPLOYMENT_COOLIFY.md`
14. `docs/10_IMPLEMENTATION_PLAN.md`
15. `docs/11_ACCEPTANCE_CRITERIA.md`
16. `docs/12_DOCS_REVIEW_AND_FIXES.md`
17. `docs/13_GITHUB_READINESS.md`
...
- Drizzle config,
- schema from `docs/05_DATABASE.md`,
- indexes,
- migration scripts,
