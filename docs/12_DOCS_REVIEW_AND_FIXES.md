# 12 — Documentation Review and Fixes
...
- `CODEX_START_PROMPT.md` was referenced but not guaranteed to exist.

Fix:

- Added root `CODEX_START_PROMPT.md` with exact phase-by-phase implementation instructions.
...
| ----------------------------------- | -----------: | ------------------------------------------------------------------------------------ |
| Missing start prompt                |        Fixed | `CODEX_START_PROMPT.md`, `AGENTS.md`                                                 |
| README not recruiter-ready          |        Fixed | `README.md`, `docs/13_GITHUB_READINESS.md`                                           |
| Task status depends on column names |        Fixed | `docs/01_PRD.md`, `docs/05_DATABASE.md`, `docs/06_API_CONTRACTS.md`                  |
| API response shapes vague           |        Fixed | `docs/06_API_CONTRACTS.md`                                                           |
| DB indexes missing                  |        Fixed | `docs/05_DATABASE.md`                                                                |
| Workspace boundary under-specified  |        Fixed | `docs/03_ARCHITECTURE.md`, `docs/05_DATABASE.md`, `docs/06_API_CONTRACTS.md`         |
| Auth/session incomplete             |        Fixed | `docs/03_ARCHITECTURE.md`, `docs/05_DATABASE.md`, `docs/06_API_CONTRACTS.md`         |
| Drag/drop endpoint insufficient     |        Fixed | `docs/05_DATABASE.md`, `docs/06_API_CONTRACTS.md`                                    |
| Deployment startup behavior vague   |        Fixed | `docs/09_DEPLOYMENT_COOLIFY.md`, `docs/10_IMPLEMENTATION_PLAN.md`                    |
| Scope too broad                     | Reduced risk | `docs/01_PRD.md`, `docs/10_IMPLEMENTATION_PLAN.md`, `docs/11_ACCEPTANCE_CRITERIA.md` |
...
```txt
Use CODEX_START_PROMPT.md and implement Phase 0 through Phase 4 first.
```
