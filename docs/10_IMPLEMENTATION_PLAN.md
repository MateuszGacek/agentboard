...
```txt
Continue from STATUS.md. Implement Phase 8 AI Improve using the contracts in docs/07_AI_FEATURE.md. Keep OpenAI backend-only and handle missing API key gracefully.
```
